...
public class GridViewFilesSelected extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button button = findViewById(R.id.btn_merge);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d("YT_AutoUpload", "Merge Button Pressed");

                for (Uri uri : selectedVideoUriList) {
                    String yourRealPath = getPath(GridViewFilesSelected.this, uri);
                    Log.d("YT_AutoUpload", "selectedVideoUriList Path : " + yourRealPath);
                }
            }
